...
*/
const char *FILENAME = "pc.log";    /* 消费生产的产品存放的缓冲文件的路径 */
...
int main(int argc, char *argv[])
{
    ...
    sem_init(&metux, 1, 1);    /* 互斥信号量，防止生产消费同时进行 */
    sem_init(&full, 1, 0);        /* 产品剩余信号量，大于0则可消费 */
    sem_init(&empty, 1, BUFFER_SIZE);    /* 空信号量，它与产品剩余信号量此消彼长，大于0时生产者才能继续生产 */
